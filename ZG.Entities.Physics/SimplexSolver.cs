...
namespace ZG
{
    public struct SurfaceConstraintInfo
    {
        ...
        public override string ToString() =>
            $"SurfaceConstraintInfo {{ ColliderKey = {ColliderKey}, Plane = {Plane}, HitPosition = {HitPosition}, Velocity = {Velocity}, VerticalComponent = {VerticalComponent}, RigidBodyIndex = {RigidBodyIndex}, Priority = {Priority}, Touched = {Touched}, IsTooSteep = {IsTooSteep} }}";
    }
